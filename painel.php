						...
						<div class="inner">
							...
							<!-- Section -->
								<section>
									...
									<div class="features">
										<article>
										<a href="pdf.php" target="_blank"><span class="icon solid fas fa-download"></span></a>
											<div class="content">
												<h3>Exame</h3>
												<p>Download do exame admissional</p>
											</div>
										</article>
										<article>
										<a href="documentos_download/carta.txt" download><span class="icon solid fas fa-download"></span></a>
											<div class="content">
												<h3>Carta</h3>
												<p>Download carta para abertura de conta</p>
											</div>
										</article>
										<article>
