																	...
																	<tbody>
																			...
																			?>
																				<tr>
																					...
																					<td><a href = "editar_rh.php?id=<?php echo $dados['ID'];?>"><i class ="material-icons">edite</i></a></td>
																					<td><a href = "delete_rh.php?id=<?php echo $dados['ID'];?>"><i class ="material-icons">delete</i></a></td>
